    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Path = table.Column<string>(type: "character varying(36)", maxLength: 36, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasicStatistics_Rating = table.Column<short>(type: "smallint", nullable: true),
                    BasicStatistics_Votes = table.Column<int>(type: "integer", nullable: true),
                    BasicStatistics_UserReviews = table.Column<int>(type: "integer", nullable: true),
                    BasicStatistics_CriticReviews = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasicStatistics_Rating = table.Column<short>(type: "smallint", nullable: false),
                    BasicStatistics_Votes = table.Column<int>(type: "integer", nullable: false),
                    BasicStatistics_UserReviews = table.Column<int>(type: "integer", nullable: false),
