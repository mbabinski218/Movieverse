...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Movieverse.Domain.Entities.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Movieverse.Domain.AggregateRoots.Media.Series", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("SeriesEnded")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("GenreMedia", b =>
                {
                    b.HasOne("Movieverse.Domain.Entities.Genre", null)
                        .WithMany()
                        .HasForeignKey("GenresId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Movieverse.Domain.AggregateRoots.Media.Media", null)
                        .WithMany()
                    ...
                    b.OwnsMany("Movieverse.Domain.Entities.Season", "Seasons", b1 =>
                        {
                            ...
                            b1.Property<short>("EpisodeCount")
                                .HasColumnType("smallint");

                            b1.Property<short>("SeasonNumber")
                                .HasColumnType("smallint");
